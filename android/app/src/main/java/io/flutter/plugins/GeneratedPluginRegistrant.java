...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new htmhell.native_shutter_sound.native_shutter_sound.NativeShutterSoundPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin native_shutter_sound, htmhell.native_shutter_sound.native_shutter_sound.NativeShutterSoundPlugin", e);
    }
    try {
    ...
    try {
      flutterEngine.getPlugins().add(new dev.flutterclutter.simple_edge_detection.SimpleEdgeDetectionPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin simple_edge_detection, dev.flutterclutter.simple_edge_detection.SimpleEdgeDetectionPlugin", e);
    }
  }
}
